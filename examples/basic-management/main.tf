...
module "ops_management" {
  ...
  management_vm_size             = "Standard_D2s_v5"
  management_vm_enable_public_ip = true # Prefer using Azure Bastion for secure access through a hub network, or restrict access via `network_management_allowed_source_addresses`.
